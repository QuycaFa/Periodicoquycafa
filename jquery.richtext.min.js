...
if(3===d.nodeType){var f=o+d.length;!p&&l.start>=o&&l.start<=f&&(s.setStart(d,l.start-o),p=!0),p&&l.end>=o&&l.end<=f&&(s.setEnd(d,l.end-o),h=!0),o=f}else
for(var u=d.childNodes.length;u--;)c.push(d.childNodes[u]);var m=window.getSelection();m.removeAllRanges(),m.addRange(s)}}
